    ...
    public partial class V1_CoreDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumLinks", x => new { x.AlbumId, x.SimilarAlbumId });
                    table.ForeignKey(
                        name: "FK_AlbumLinks_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AlbumLinks_Albums_SimilarAlbumId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistLinks", x => new { x.ArtistId, x.SimilarArtistId });
                    table.ForeignKey(
                        name: "FK_ArtistLinks_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArtistLinks_Artists_SimilarArtistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongsLinks", x => new { x.SongId, x.SimilarSongId });
                    table.ForeignKey(
                        name: "FK_SongsLinks_Songs_SimilarSongId",
                        column: x => x.SimilarSongId,
                        principalTable: "Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SongsLinks_Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumLinks_SimilarAlbumId",
                table: "AlbumLinks",
                column: "SimilarAlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtistLinks_SimilarArtistId",
                table: "ArtistLinks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongsLinks_SimilarSongId",
                table: "SongsLinks",
